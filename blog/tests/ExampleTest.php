...
class ExampleTest extends TestCase
{
    ...
    //   $this->post(route('api.product.store'),$product->jsonSerialize(),$this->jsonHeaders)
    //         ->seeInDatabase('products',['name'=>$product->name])
    //         ->assertResponseOk();
    // }
    // —————————————————————————
    ...
    public function testProductDescriptionCreation()
    {
      ...
      $this->post(route('api.descriptions.store',['products'=>$product->id]),$products->jsonSerialize(),$this->jsonHeaders)
